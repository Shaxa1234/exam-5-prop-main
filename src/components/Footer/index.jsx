...
const index = () => {
  ...
  return (
    <footer id="contact">
      <section className="dark:bg-[#030712] dark:text-white">
      ...
      <div className="expertize flex flex-col">
        ...
        <div className=" items-center flex flex-col">
          ...
          <img src={C_icon} alt="" />
          <h2 className="finish">2023 | <span className="underline"> Designed </span> and <span className="underline">coded</span> with ❤️️ by NAJOT TA’LIM</h2>
        </div>  
        </div>
